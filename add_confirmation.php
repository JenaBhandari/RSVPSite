<?php
	...
	if ( !isset($_POST['name']) || trim($_POST['name'] ) == '')
		...
		$sql = "INSERT INTO party_list(name, plus_one, rsvp_id, item_id)
						VALUES('$name', $plus_one, $rsvp_id, $item_id);";
...
<html lang="en">
  <head>
	...
	<meta name="description" content="Shows if the person was successfully added to the invite list.">
		...
		<div class = "row no-gutters">
			...
			<div class="container">
				...
				<div class="row mt-4 mb-4">
					<div class="col-12">
						<a href="add_form.php" role="button" class="btn btn-primary">Back to Add Guest</a>
					</div> <!-- .col -->
				</div> <!-- .row -->
			</div> <!-- .container -->
