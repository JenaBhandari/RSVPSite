...
<html lang="en">
  <head>
	...
	<meta name="description" content="Allows the user to add a person to the invite list for the party. Can add all details, like rsvp, plus one, and what they are bringing.">
				...
				<div class="container">
					...
					<form action="add_confirmation.php" method="POST">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input type="number" class="form-control" id="plus_one_id" name="plus_one" >
